...
public class RestControler {
   ...
   private Resultado resultado;
    ...
    public ResponseEntity<Resposta> addition(@RequestParam(required = false) BigDecimal a,
        ...
        Resposta response = new Resposta("Operador adicionar executado e adicionado a quee com sucesso Resultado=" + resultado.getResultado());
        //response.setMessage("Operador adicionar executado e adicionado a quee com sucesso");
